...
public class BlueBaseFarCorner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        intake.setPower(1.0);
        path = drive.actionBuilder(new Pose2d(-19.1, -16, Math.toRadians(229)))
        ...
        path = drive.actionBuilder(new Pose2d(-9.5, -50, Math.toRadians(271)))
                .strafeToLinearHeading(new Vector2d(-19, -16), Math.toRadians(229))
                .build();
        Actions.runBlocking(path);
        fireBpulse(intake, shooter, shooterStartPower);
        ...
        intake.setPower(1.0);
        path = drive.actionBuilder(new Pose2d(-19, -16, Math.toRadians(229)))
                .strafeToLinearHeading(new Vector2d(-19.1, -16), Math.toRadians(229))
        ...
        path = drive.actionBuilder(new Pose2d(14, -14, Math.toRadians(0)))
                .strafeToLinearHeading(new Vector2d(-19, -16), Math.toRadians(229))
                .build();
        Actions.runBlocking(path);
